...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      apiShippingUrl: process.env.API_SHIPPING_URL || 'http://localhost:4001',
    },
    ...
    apiShippingInternalUrl: process.env.API_SHIPPING_INTERNAL_URL || 'http://shipping-service:4001',
  }
})
